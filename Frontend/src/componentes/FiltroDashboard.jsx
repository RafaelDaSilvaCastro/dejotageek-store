function FiltroDashboard() {
  return (
    <div className="flex items-center text-cinza-claro gap-12">
      ...
      <div className="flex items-center">
        <select
          ...
          name="Categoria"
          required
          className="  outline-none drop-shadow-[0px_3px_7px_rgba(0,0,0,0.25)] rounded-lg h-10 p-2 bg-white text-cinza-claro w-80 "
        >
